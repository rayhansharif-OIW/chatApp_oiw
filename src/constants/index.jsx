export const services_1 = [
  {
    ...
    text_caption: "Easy integration",

    text: "With Xora, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
   buttons: [
      { id: "0", text: "Habit building essential choose habit",icon:"images/icons/brain.svg" },
      { id: "1", text: "Get an overview of Habit Calendars.",icon:"images/icons/drop.svg"  },
      { id: "2", text: "Start building with Habitify platform",icon:"images/icons/timer.svg"  },
    ],
  },
  {
    id: "1",
    image: "/images/collaboration.png",
    text_caption: "Easy integration 2",
    text: "2 Your data security is our priority. With state-of-the-art encryption and robust privacy controls, Xora helps keeps your information secure and locked up tighter than Fort Knox.",
   buttons: [
      { id: "0", text: "Habit building essential choose habit",icon:"images/icons/brain.svg" },
      { id: "1", text: "Get an overview of Habit Calendars.",icon:"images/icons/drop.svg"  },
      { id: "2", text: "Start building with Habitify platform",icon:"images/icons/timer.svg"  },
  ...
  },
  {
    id: "2",
    image: "/images/sells-by-country.png",
    text_caption: "Easy integration 3",
    text: "3 Your data security is our priority. With state-of-the-art encryption and robust privacy controls, Xora helps keeps your information secure and locked up tighter than Fort Knox.",
    buttons: [
      { id: "0", text: "Habit building essential choose habit",icon:"images/icons/brain.svg" },
      { id: "1", text: "Get an overview of Habit Calendars.",icon:"images/icons/drop.svg"  },
      { id: "2", text: "Start building with Habitify platform",icon:"images/icons/timer.svg"  },
